...
-- AddForeignKey
ALTER TABLE `Relationship` ADD CONSTRAINT `Relationship_recieveId_fkey` FOREIGN KEY (`recieveId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
